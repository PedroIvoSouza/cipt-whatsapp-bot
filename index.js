...
wppconnect.create({
  ...
  puppeteerOptions: {
    ...
    executablePath: '/usr/bin/google-chrome-stable' // evita buscar chrome no cache
  },
  catchQR: (base64Qr, asciiQR) => {
    console.log('⚡ QRCode recebido (ASCII):');
    console.log(asciiQR);
    fs.writeFileSync('qrcode.html', `<img src="${base64Qr}">`);
    console.log('⚡ QRCode salvo em qrcode.html — abra no Codespaces Preview e escaneie com o WhatsApp.');
  },
  tokenStore: 'file',
  disableWelcome: true
})
